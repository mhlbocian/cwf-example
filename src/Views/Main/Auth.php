...
<p><b>Add user</b></p>
<form action="<?= Url::Site("/Forms/AddUser") ?>" method="post">
...
<p><b>Delete user</b></p>
<form action="<?= Url::Site("/Forms/DelUser") ?>" method="post">
    <label for="inpUsername">Username:</label>
...
<p><b>Add group</b></p>
<form action="<?= Url::Site("/Forms/AddGroup") ?>" method="post">
...
<form action="<?= Url::Site("/Forms/DelGroup") ?>" method="post">
    <label for="inpGroupname">Group name:</label>
...
<h3>Membership</h3>
<form action="<?= Url::Site("/Forms/Membership") ?>" method="post">
    <label for="inpUsername">Username:</label>
